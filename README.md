...
<html b:css='false' b:defaultwidgetversion='2' b:layoutsVersion='3' b:responsive='true' b:templateUrl='fancy.xml' b:templateVersion='1.3.3' expr:dir='data:blog.languageDirection' expr:lang='data:blog.locale' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  <head> <meta content='UDfcnKuL0789nOWf2tChSQAtJFvgR0-XsiuWWPK472Y' name='google-site-verification'/>
...
z-index:32
              ...
              <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                <div class='search'>
                  ...
                  <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                    <b:widget id='BlogSearch1' locked='true' title='Buscar este blog' type='BlogSearch' visible='true'>
                      <b:includable id='main'>
            ...
            <b:include name='super.searchSubmit'/>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='MOD HUB (Encabezado)' type='Header' visible='true'>
                    <b:widget-settings>
            ...
            <b:include name='super.title'/>
                ...
                <nav role='navigation'>
                  <b:section id='page_list_top' name='Page List (Top)' showaddelement='false'>
                    <b:widget id='PageList1' locked='true' title='Páginas' type='PageList' visible='true'>
                      <b:widget-settings>
                        <b:widget-setting name='pageListJson'><![CDATA[{"link0":{"href":"http://web20261.blogspot.com/","position":0,"title":"Página Principal"}}]]></b:widget-setting>
          ...
          <main class='centered-bottom' id='main' role='main' tabindex='-1'>
            ...
            <b:section ads='true' class='main' id='page_body' name='Page Body' showaddelement='false'>
              <b:widget id='HTML1' locked='false' title='' type='HTML' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='content'><![CDATA[<!-- ========================================================= MOD HUB — PÁGINA PRINCIPAL Diseñada para Blogger ========================================================= --> <style> /* ========================================================= RESET ========================================================= */ #MODHUB{ --mh-blue:#087cff; --mh-blue2:#0755b5; --mh-cyan:#00c8ff; --mh-bg:#050914; --mh-bg2:#081120; --mh-card:rgba(12,22,40,.82); --mh-border:rgba(8,124,255,.28); --mh-text:#ffffff; --mh-muted:#91a4bd; --mh-shadow:0 0 35px rgba(8,124,255,.18); margin:0; padding:0; width:100%; min-height:100vh; box-sizing:border-box; color:var(--mh-text); font-family:Arial,Helvetica,sans-serif; background: radial-gradient(circle at 15% 10%,rgba(8,124,255,.18),transparent 30%), radial-gradient(circle at 85% 25%,rgba(0,200,255,.10),transparent 28%), linear-gradient(180deg,#030711 0%,#06101f 50%,#030711 100%); overflow:hidden; } #MODHUB *, #MODHUB *::before, #MODHUB *::after{ box-sizing:border-box; } #MODHUB a{ text-decoration:none; color:inherit; } #MODHUB button, #MODHUB input{ font-family:inherit; } /* ========================================================= BACKGROUND ========================================================= */ #MODHUB .mh-bg-grid{ position:fixed; inset:0; z-index:0; pointer-events:none; opacity:.18; background-image: linear-gradient(rgba(8,124,255,.15) 1px,transparent 1px), linear-gradient(90deg,rgba(8,124,255,.15) 1px,transparent 1px); background-size:55px 55px; mask-image:linear-gradient(to bottom,black,transparent); } #MODHUB .mh-orb{ position:fixed; width:300px; height:300px; border-radius:50%; background:rgba(8,124,255,.12); filter:blur(70px); pointer-events:none; z-index:0; animation:mhFloat 8s ease-in-out infinite; } #MODHUB .mh-orb.one{ left:-120px; top:180px; } #MODHUB .mh-orb.two{ right:-120px; top:600px; animation-delay:2s; } @keyframes mhFloat{ 0%,100%{transform:translateY(0)} 50%{transform:translateY(-35px)} } /* ========================================================= HEADER ========================================================= */ #MODHUB .mh-header{ position:sticky; top:0; z-index:1000; width:100%; background:rgba(3,8,18,.86); backdrop-filter:blur(18px); border-bottom:1px solid rgba(8,124,255,.20); } #MODHUB .mh-header-inner{ width:min(1250px,94%); height:74px; margin:auto; display:flex; align-items:center; justify-content:space-between; gap:20px; } #MODHUB .mh-logo{ display:flex; align-items:center; gap:11px; min-width:max-content; } #MODHUB .mh-logo-icon{ width:43px; height:43px; border-radius:13px; display:grid; place-items:center; font-size:22px; background:linear-gradient(135deg,var(--mh-blue),var(--mh-blue2)); box-shadow:0 0 22px rgba(8,124,255,.55); } #MODHUB .mh-logo-text{ font-size:22px; font-weight:900; letter-spacing:1.5px; text-shadow:0 0 15px rgba(8,124,255,.7); } #MODHUB .mh-logo-text span{ color:var(--mh-cyan); } #MODHUB .mh-nav{ display:flex; align-items:center; gap:5px; } #MODHUB .mh-nav a{ padding:11px 14px; border-radius:10px; color:#c6d5e8; font-size:14px; font-weight:700; transition:.25s; } #MODHUB .mh-nav a:hover, #MODHUB .mh-nav a.active{ color:#fff; background:rgba(8,124,255,.13); box-shadow:inset 0 -2px 0 var(--mh-blue); } #MODHUB .mh-user{ display:flex; align-items:center; gap:9px; padding:7px 12px 7px 7px; border:1px solid var(--mh-border); border-radius:30px; background:rgba(8,124,255,.07); cursor:pointer; transition:.25s; } #MODHUB .mh-user:hover{ transform:translateY(-2px); box-shadow:0 0 20px rgba(8,124,255,.2); } #MODHUB .mh-avatar{ width:35px; height:35px; border-radius:50%; display:grid; place-items:center; background:linear-gradient(135deg,var(--mh-blue),#003c87); font-size:17px; } #MODHUB .mh-user-name{ font-size:13px; font-weight:800; } #MODHUB .mh-menu-btn{ display:none; border:0; background:transparent; color:#fff; font-size:27px; cursor:pointer; } /* ========================================================= HERO ========================================================= */ #MODHUB .mh-hero{ position:relative; z-index:1; width:min(1250px,94%); min-height:570px; margin:auto; display:grid; grid-template-columns:1.15fr .85fr; align-items:center; gap:40px; padding:75px 0 60px; } #MODHUB .mh-badge{ display:inline-flex; align-items:center; gap:8px; padding:8px 13px; border-radius:30px; color:#8edcff; background:rgba(0,200,255,.08); border:1px solid rgba(0,200,255,.20); font-size:12px; font-weight:800; text-transform:uppercase; letter-spacing:1px; margin-bottom:20px; } #MODHUB .mh-badge i{ width:7px; height:7px; border-radius:50%; background:#00d9ff; box-shadow:0 0 12px #00d9ff; animation:mhPulse 1.5s infinite; } @keyframes mhPulse{ 0%,100%{opacity:1} 50%{opacity:.3} } #MODHUB .mh-title{ margin:0; font-size:clamp(48px,7vw,88px); line-height:.95; font-weight:1000; letter-spacing:-4px; } #MODHUB .mh-title .blue{ color:var(--mh-blue); text-shadow: 0 0 10px rgba(8,124,255,.65), 0 0 35px rgba(8,124,255,.3); } #MODHUB .mh-title .white{ display:block; } #MODHUB .mh-description{ max-width:650px; margin:25px 0; color:var(--mh-muted); font-size:17px; line-height:1.7; } #MODHUB .mh-actions{ display:flex; flex-wrap:wrap; gap:12px; } #MODHUB .mh-btn{ display:inline-flex; justify-content:center; align-items:center; gap:9px; min-height:48px; padding:0 20px; border-radius:12px; font-size:14px; font-weight:900; cursor:pointer; transition:.25s; } #MODHUB .mh-btn-primary{ color:#fff; border:1px solid rgba(0,200,255,.25); background:linear-gradient(135deg,var(--mh-blue),var(--mh-blue2)); box-shadow:0 8px 28px rgba(8,124,255,.25); } #MODHUB .mh-btn-primary:hover{ transform:translateY(-3px); box-shadow:0 12px 35px rgba(8,124,255,.38); } #MODHUB .mh-btn-secondary{ color:#dceaff; border:1px solid rgba(8,124,255,.30); background:rgba(8,124,255,.07); } #MODHUB .mh-btn-secondary:hover{ background:rgba(8,124,255,.15); transform:translateY(-3px); } /* ========================================================= HERO VISUAL ========================================================= */ #MODHUB .mh-hero-visual{ position:relative; min-height:420px; display:grid; place-items:center; } #MODHUB .mh-ring{ position:absolute; width:340px; height:340px; border:1px solid rgba(8,124,255,.20); border-radius:50%; animation:mhSpin 20s linear infinite; } #MODHUB .mh-ring::before, #MODHUB .mh-ring::after{ content:""; position:absolute; border-radius:50%; border:1px solid rgba(0,200,255,.15); } #MODHUB .mh-ring::before{ inset:30px; } #MODHUB .mh-ring::after{ inset:65px; } @keyframes mhSpin{ to{transform:rotate(360deg)} } #MODHUB .mh-core{ position:relative; width:245px; height:245px; border-radius:35px; display:grid; place-items:center; background: radial-gradient(circle at 35% 30%,rgba(0,200,255,.25),transparent 35%), linear-gradient(145deg,#0c2444,#06101f); border:1px solid rgba(8,124,255,.42); box-shadow: 0 0 40px rgba(8,124,255,.25), inset 0 0 50px rgba(8,124,255,.10); transform:rotate(-5deg); } #MODHUB .mh-core-content{ text-align:center; transform:rotate(5deg); } #MODHUB .mh-core-icon{ font-size:75px; filter:drop-shadow(0 0 18px rgba(0,200,255,.6)); } #MODHUB .mh-core h3{ margin:10px 0 0; font-size:28px; font-weight:1000; } #MODHUB .mh-core p{ margin:5px 0 0; color:#7ea7cf; font-size:11px; letter-spacing:2px; text-transform:uppercase; } #MODHUB .mh-floating{ position:absolute; padding:11px 14px; border-radius:12px; background:rgba(8,17,32,.9); border:1px solid rgba(8,124,255,.25); box-shadow:0 10px 35px rgba(0,0,0,.25); font-size:12px; font-weight:800; animation:mhFloatCard 4s ease-in-out infinite; } #MODHUB .mh-floating.a{ top:45px; right:5px; } #MODHUB .mh-floating.b{ bottom:55px; left:0; animation-delay:1.2s; } @keyframes mhFloatCard{ 0%,100%{transform:translateY(0)} 50%{transform:translateY(-10px)} } /* ========================================================= STATS ========================================================= */ #MODHUB .mh-stats{ position:relative; z-index:2; width:min(1050px,94%); margin:0 auto 55px; display:grid; grid-template-columns:repeat(3,1fr); border:1px solid rgba(8,124,255,.18); border-radius:18px; overflow:hidden; background:rgba(7,16,30,.72); backdrop-filter:blur(12px); } #MODHUB .mh-stat{ padding:25px; text-align:center; border-right:1px solid rgba(8,124,255,.14); } #MODHUB .mh-stat:last-child{ border-right:0; } #MODHUB .mh-stat strong{ display:block; font-size:27px; color:#fff; } #MODHUB .mh-stat span{ display:block; margin-top:5px; color:#738ba8; font-size:12px; } /* ========================================================= MAIN CONTENT ========================================================= */ #MODHUB .mh-main{ position:relative; z-index:2; width:min(1250px,94%); margin:auto; } #MODHUB .mh-section{ margin-bottom:70px; } #MODHUB .mh-section-head{ display:flex; align-items:end; justify-content:space-between; gap:20px; margin-bottom:24px; } #MODHUB .mh-section-title{ margin:0; font-size:27px; font-weight:950; } #MODHUB .mh-section-title span{ color:var(--mh-blue); } #MODHUB .mh-section-link{ color:#74a9d8; font-size:13px; font-weight:800; } #MODHUB .mh-section-link:hover{ color:#fff; } /* ========================================================= SEARCH ========================================================= */ #MODHUB .mh-search{ margin-bottom:30px; } #MODHUB .mh-search-box{ position:relative; max-width:700px; margin:auto; } #MODHUB .mh-search-box input{ width:100%; height:55px; padding:0 55px 0 20px; color:#fff; background:rgba(8,18,34,.9); border:1px solid rgba(8,124,255,.25); border-radius:15px; outline:0; font-size:14px; transition:.25s; } #MODHUB .mh-search-box input:focus{ border-color:var(--mh-blue); box-shadow:0 0 25px rgba(8,124,255,.15); } #MODHUB .mh-search-box button{ position:absolute; right:6px; top:6px; width:43px; height:43px; border:0; border-radius:11px; color:#fff; background:linear-gradient(135deg,var(--mh-blue),var(--mh-blue2)); cursor:pointer; font-size:18px; } /* ========================================================= CATEGORIES ========================================================= */ #MODHUB .mh-categories{ display:grid; grid-template-columns:repeat(8,1fr); gap:12px; } #MODHUB .mh-category{ min-height:105px; padding:15px 8px; display:flex; flex-direction:column; justify-content:center; align-items:center; gap:10px; border-radius:15px; background:rgba(9,19,35,.78); border:1px solid rgba(8,124,255,.15); transition:.25s; cursor:pointer; } #MODHUB .mh-category:hover{ transform:translateY(-5px); border-color:rgba(8,124,255,.5); background:rgba(8,124,255,.10); box-shadow:var(--mh-shadow); } #MODHUB .mh-category-icon{ font-size:28px; } #MODHUB .mh-category span{ color:#b7c8da; font-size:12px; font-weight:800; } /* ========================================================= CARDS ========================================================= */ #MODHUB .mh-grid{ display:grid; grid-template-columns:repeat(4,1fr); gap:18px; } #MODHUB .mh-card{ position:relative; overflow:hidden; border:1px solid rgba(8,124,255,.17); border-radius:17px; background:linear-gradient(180deg,rgba(12,24,43,.92),rgba(6,14,27,.96)); transition:.28s; } #MODHUB .mh-card:hover{ transform:translateY(-6px); border-color:rgba(8,124,255,.45); box-shadow:0 18px 45px rgba(0,0,0,.28),0 0 25px rgba(8,124,255,.12); } #MODHUB .mh-card-image{ height:170px; position:relative; display:grid; place-items:center; overflow:hidden; background: radial-gradient(circle at 50% 30%,rgba(8,124,255,.35),transparent 40%), linear-gradient(135deg,#0a1d38,#030913); } #MODHUB .mh-card-image::after{ content:""; position:absolute; inset:0; background:linear-gradient(180deg,transparent 50%,rgba(3,8,17,.9)); } #MODHUB .mh-card-game-icon{ font-size:70px; filter:drop-shadow(0 0 20px rgba(8,124,255,.5)); transition:.3s; } #MODHUB .mh-card:hover .mh-card-game-icon{ transform:scale(1.12); } #MODHUB .mh-tag{ position:absolute; top:11px; left:11px; z-index:2; padding:5px 8px; border-radius:7px; color:#a9ddff; background:rgba(4,15,29,.78); border:1px solid rgba(0,200,255,.18); font-size:10px; font-weight:900; } #MODHUB .mh-card-body{ padding:17px; } #MODHUB .mh-card-title{ margin:0 0 7px; font-size:16px; font-weight:900; } #MODHUB .mh-card-description{ height:36px; overflow:hidden; margin:0 0 13px; color:#7f95ad; font-size:12px; line-height:1.5; } #MODHUB .mh-card-meta{ display:flex; align-items:center; justify-content:space-between; gap:10px; color:#7188a1; font-size:10px; margin-bottom:13px; } #MODHUB .mh-card-meta strong{ color:#ffd35a; } #MODHUB .mh-card-btn{ display:flex; justify-content:center; align-items:center; height:40px; border-radius:10px; background:rgba(8,124,255,.10); border:1px solid rgba(8,124,255,.20); color:#9acaff; font-size:12px; font-weight:900; transition:.2s; } #MODHUB .mh-card-btn:hover{ color:#fff; background:linear-gradient(135deg,var(--mh-blue),var(--mh-blue2)); } /* ========================================================= FEATURED ========================================================= */ #MODHUB .mh-featured{ display:grid; grid-template-columns:1fr 1fr; gap:20px; } #MODHUB .mh-feature-card{ min-height:270px; position:relative; overflow:hidden; border-radius:20px; border:1px solid rgba(8,124,255,.20); background: radial-gradient(circle at 80% 20%,rgba(0,200,255,.18),transparent 35%), linear-gradient(135deg,#0b2442,#050b16 70%); } #MODHUB .mh-feature-content{ position:relative; z-index:2; max-width:65%; padding:30px; } #MODHUB .mh-feature-content small{ color:#5bbdff; font-weight:900; text-transform:uppercase; letter-spacing:1px; } #MODHUB .mh-feature-content h3{ margin:12px 0 10px; font-size:28px; } #MODHUB .mh-feature-content p{ color:#879db6; font-size:13px; line-height:1.6; } #MODHUB .mh-feature-art{ position:absolute; right:-15px; bottom:-30px; font-size:150px; opacity:.8; filter:drop-shadow(0 0 25px rgba(8,124,255,.4)); transform:rotate(-7deg); } /* ========================================================= POSTS ========================================================= */ #MODHUB .mh-posts{ display:grid; grid-template-columns:repeat(3,1fr); gap:18px; } #MODHUB .mh-post{ padding:22px; border-radius:17px; background:rgba(8,17,31,.82); border:1px solid rgba(8,124,255,.15); } #MODHUB .mh-post-date{ color:#5b9bd0; font-size:10px; font-weight:900; text-transform:uppercase; } #MODHUB .mh-post h3{ margin:10px 0; font-size:17px; } #MODHUB .mh-post p{ margin:0 0 15px; color:#7e94ad; font-size:12px; line-height:1.6; } #MODHUB .mh-post a{ color:#66baff; font-size:12px; font-weight:900; } /* ========================================================= PROFILE PANEL ========================================================= */ #MODHUB .mh-profile-panel{ position:fixed; top:82px; right:25px; width:280px; z-index:2000; padding:20px; display:none; border-radius:18px; background:rgba(5,12,24,.97); border:1px solid rgba(8,124,255,.30); box-shadow:0 20px 50px rgba(0,0,0,.45); backdrop-filter:blur(20px); } #MODHUB .mh-profile-panel.show{ display:block; animation:mhPanel .2s ease; } @keyframes mhPanel{ from{opacity:0;transform:translateY(-8px)} to{opacity:1;transform:translateY(0)} } #MODHUB .mh-profile-top{ text-align:center; padding-bottom:18px; border-bottom:1px solid rgba(8,124,255,.13); } #MODHUB .mh-profile-avatar{ width:70px; height:70px; margin:auto; display:grid; place-items:center; border-radius:50%; background:linear-gradient(135deg,var(--mh-blue),#003b80); font-size:30px; box-shadow:0 0 25px rgba(8,124,255,.3); } #MODHUB .mh-profile-top h3{ margin:12px 0 4px; } #MODHUB .mh-profile-top p{ margin:0; color:#7289a4; font-size:11px; } #MODHUB .mh-profile-links{ padding-top:12px; display:grid; gap:5px; } #MODHUB .mh-profile-links a{ padding:12px; border-radius:9px; color:#b9cbe0; font-size:12px; font-weight:800; } #MODHUB .mh-profile-links a:hover{ background:rgba(8,124,255,.10); color:#fff; } /* ========================================================= FOOTER ========================================================= */ #MODHUB .mh-footer{ position:relative; z-index:2; margin-top:30px; padding:45px 0 30px; border-top:1px solid rgba(8,124,255,.14); background:rgba(2,7,15,.75); } #MODHUB .mh-footer-inner{ width:min(1250px,94%); margin:auto; display:flex; align-items:center; justify-content:space-between; gap:20px; } #MODHUB .mh-footer-logo{ font-weight:1000; letter-spacing:1px; } #MODHUB .mh-footer-logo span{ color:var(--mh-blue); } #MODHUB .mh-footer p{ margin:5px 0 0; color:#60758e; font-size:11px; } #MODHUB .mh-footer-links{ display:flex; flex-wrap:wrap; gap:15px; } #MODHUB .mh-footer-links a{ color:#738ba4; font-size:11px; } #MODHUB .mh-footer-links a:hover{ color:#fff; } /* ========================================================= MOBILE ========================================================= */ @media(max-width:1000px){ #MODHUB .mh-nav{ display:none; position:absolute; left:3%; right:3%; top:70px; padding:12px; flex-direction:column; align-items:stretch; background:rgba(4,11,22,.98); border:1px solid rgba(8,124,255,.22); border-radius:15px; } #MODHUB .mh-nav.show{ display:flex; } #MODHUB .mh-nav a{ padding:13px; } #MODHUB .mh-menu-btn{ display:block; } #MODHUB .mh-user-name{ display:none; } #MODHUB .mh-hero{ grid-template-columns:1fr; padding-top:55px; text-align:center; } #MODHUB .mh-description{ margin-left:auto; margin-right:auto; } #MODHUB .mh-actions{ justify-content:center; } #MODHUB .mh-hero-visual{ min-height:350px; } #MODHUB .mh-categories{ grid-template-columns:repeat(4,1fr); } #MODHUB .mh-grid{ grid-template-columns:repeat(2,1fr); } } @media(max-width:650px){ #MODHUB .mh-header-inner{ height:65px; } #MODHUB .mh-logo-text{ font-size:18px; } #MODHUB .mh-logo-icon{ width:38px; height:38px; font-size:18px; } #MODHUB .mh-title{ font-size:50px; letter-spacing:-3px; } #MODHUB .mh-description{ font-size:14px; } #MODHUB .mh-hero{ min-height:auto; padding:45px 0 30px; } #MODHUB .mh-ring{ width:260px; height:260px; } #MODHUB .mh-core{ width:190px; height:190px; } #MODHUB .mh-core-icon{ font-size:55px; } #MODHUB .mh-core h3{ font-size:23px; } #MODHUB .mh-floating{ display:none; } #MODHUB .mh-stats{ grid-template-columns:1fr; } #MODHUB .mh-stat{ border-right:0; border-bottom:1px solid rgba(8,124,255,.14); } #MODHUB .mh-stat:last-child{ border-bottom:0; } #MODHUB .mh-categories{ grid-template-columns:repeat(2,1fr); } #MODHUB .mh-grid{ grid-template-columns:1fr; } #MODHUB .mh-featured{ grid-template-columns:1fr; } #MODHUB .mh-feature-content{ max-width:75%; } #MODHUB .mh-posts{ grid-template-columns:1fr; } #MODHUB .mh-footer-inner{ flex-direction:column; text-align:center; } #MODHUB .mh-profile-panel{ right:3%; left:3%; width:auto; } } </style> <div id="MODHUB"> <!-- FONDO --> <div class="mh-bg-grid"></div> <div class="mh-orb one"></div> <div class="mh-orb two"></div> <!-- ===================================================== HEADER ====================================================== --> <header class="mh-header"> <div class="mh-header-inner"> <a href="/" class="mh-logo"> <div class="mh-logo-icon">🎮</div> <div class="mh-logo-text"> MOD <span>HUB</span> </div> </a> <nav class="mh-nav" id="mhNavigation"> <a href="/" class="active"> 🏠 Inicio </a> <a href="/search/label/Mods"> 🎮 Mods </a> <a href="/search/label/Juegos"> 🕹️ Juegos </a> <a href="#categorias"> 📚 Categorías </a> <a href="#destacados"> ⭐ Destacados </a> </nav> <div style="display:flex;align-items:center;gap:8px;"> <div class="mh-user" id="mhUserButton"> <div class="mh-avatar"> 👤 </div> <div class="mh-user-name"> Mi perfil </div> </div> <button class="mh-menu-btn" id="mhMenuButton"> ☰ </button> </div> </div> </header> <!-- ===================================================== PERFIL ====================================================== --> <div class="mh-profile-panel" id="mhProfilePanel"> <div class="mh-profile-top"> <div class="mh-profile-avatar"> 👤 </div> <h3>Mi perfil</h3> <p>Inicia sesión para continuar</p> </div> <div class="mh-profile-links"> <a href="/p/iniciar-sesion.html"> 🔐 Iniciar sesión </a> <a href="/p/mi-perfil.html"> 👤 Ver mi perfil </a> <a href="/p/registrarse.html"> ✨ Crear cuenta </a> </div> </div> <!-- ===================================================== HERO ====================================================== --> <section class="mh-hero"> <div> <div class="mh-badge"> <i></i> Bienvenido a MOD HUB </div> <h1 class="mh-title"> <span class="white"> DESCUBRE </span> <span class="blue"> MOD HUB </span> </h1> <p class="mh-description"> Explora juegos, mods, novedades y contenido gaming en un solo lugar. Descubre nuevas experiencias y encuentra tus próximos juegos favoritos. </p> <div class="mh-actions"> <a href="#mods" class="mh-btn mh-btn-primary"> 🎮 Explorar Mods </a> <a href="#juegos" class="mh-btn mh-btn-secondary"> 🕹️ Ver Juegos </a> </div> </div> <div class="mh-hero-visual"> <div class="mh-ring"></div> <div class="mh-floating a"> ⚡ NUEVO CONTENIDO </div> <div class="mh-floating b"> 🎮 GAMING HUB </div> <div class="mh-core"> <div class="mh-core-content"> <div class="mh-core-icon"> 🎮 </div> <h3>MOD HUB</h3> <p>Gaming Community</p> </div> </div> </div> </section> <!-- ===================================================== ESTADÍSTICAS ====================================================== --> <div class="mh-stats"> <div class="mh-stat"> <strong>🎮</strong> <span>Mods y juegos</span> </div> <div class="mh-stat"> <strong>🔥</strong> <span>Contenido destacado</span> </div> <div class="mh-stat"> <strong>🚀</strong> <span>Actualizaciones</span> </div> </div> <main class="mh-main"> <!-- =================================================== BUSCADOR ==================================================== --> <section class="mh-section mh-search"> <div class="mh-search-box"> <input type="text" id="mhSearchInput" placeholder="Buscar juegos, mods o contenido..." autocomplete="off" /> <button id="mhSearchButton"> 🔍 </button> </div> </section> <!-- =================================================== CATEGORÍAS ==================================================== --> <section class="mh-section" id="categorias"> <div class="mh-section-head"> <h2 class="mh-section-title"> Explora por <span>categoría</span> </h2> </div> <div class="mh-categories"> <a class="mh-category" href="/search/label/Accion"> <div class="mh-category-icon">⚔️</div> <span>Acción</span> </a> <a class="mh-category" href="/search/label/Carreras"> <div class="mh-category-icon">🏎️</div> <span>Carreras</span> </a> <a class="mh-category" href="/search/label/Deportes"> <div class="mh-category-icon">⚽</div> <span>Deportes</span> </a> <a class="mh-category" href="/search/label/Terror"> <div class="mh-category-icon">👻</div> <span>Terror</span> </a> <a class="mh-category" href="/search/label/Aventura"> <div class="mh-category-icon">🗺️</div> <span>Aventura</span> </a> <a class="mh-category" href="/search/label/RPG"> <div class="mh-category-icon">🧙</div> <span>RPG</span> </a> <a class="mh-category" href="/search/label/Shooter"> <div class="mh-category-icon">🎯</div> <span>Shooter</span> </a> <a class="mh-category" href="/search/label/Otros"> <div class="mh-category-icon">🎲</div> <span>Otros</span> </a> </div> </section> <!-- =================================================== MODS DESTACADOS ==================================================== --> <section class="mh-section" id="mods"> <div class="mh-section-head"> <h2 class="mh-section-title"> 🎮 Mods <span>destacados</span> </h2> <a href="/search/label/Mods" class="mh-section-link"> Ver todos → </a> </div> <div class="mh-grid"> <article class="mh-card"> <div class="mh-card-image"> <span class="mh-tag"> DESTACADO </span> <div class="mh-card-game-icon"> 🎮 </div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Mod Gaming #1 </h3> <p class="mh-card-description"> Descubre este nuevo contenido para tu juego. </p> <div class="mh-card-meta"> <span>🎮 Gaming</span> <strong>★ 4.9</strong> </div> <a href="/search/label/Mods" class="mh-card-btn"> VER MOD </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <span class="mh-tag"> NUEVO </span> <div class="mh-card-game-icon"> ⚔️ </div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Mod Action </h3> <p class="mh-card-description"> Una nueva experiencia llena de acción. </p> <div class="mh-card-meta"> <span>⚔️ Acción</span> <strong>★ 4.8</strong> </div> <a href="/search/label/Mods" class="mh-card-btn"> VER MOD </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <span class="mh-tag"> POPULAR </span> <div class="mh-card-game-icon"> 🏎️ </div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Racing Mod </h3> <p class="mh-card-description"> Personaliza tu experiencia de carreras. </p> <div class="mh-card-meta"> <span>🏎️ Carreras</span> <strong>★ 4.7</strong> </div> <a href="/search/label/Mods" class="mh-card-btn"> VER MOD </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <span class="mh-tag"> NUEVO </span> <div class="mh-card-game-icon"> 👻 </div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Horror Mod </h3> <p class="mh-card-description"> Entra en una experiencia de terror diferente. </p> <div class="mh-card-meta"> <span>👻 Terror</span> <strong>★ 4.6</strong> </div> <a href="/search/label/Mods" class="mh-card-btn"> VER MOD </a> </div> </article> </div> </section> <!-- =================================================== JUEGOS ==================================================== --> <section class="mh-section" id="juegos"> <div class="mh-section-head"> <h2 class="mh-section-title"> 🕹️ Juegos <span>destacados</span> </h2> <a href="/search/label/Juegos" class="mh-section-link"> Ver todos → </a> </div> <div class="mh-grid"> <article class="mh-card"> <div class="mh-card-image"> <div class="mh-card-game-icon">🎯</div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Game Zone </h3> <p class="mh-card-description"> Acción y aventura para los amantes del gaming. </p> <div class="mh-card-meta"> <span>Acción</span> <strong>★ 5.0</strong> </div> <a href="/search/label/Juegos" class="mh-card-btn"> VER JUEGO </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <div class="mh-card-game-icon">🏆</div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Ultimate Game </h3> <p class="mh-card-description"> Descubre un nuevo desafío y supera tus límites. </p> <div class="mh-card-meta"> <span>Deportes</span> <strong>★ 4.9</strong> </div> <a href="/search/label/Juegos" class="mh-card-btn"> VER JUEGO </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <div class="mh-card-game-icon">🗺️</div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> Adventure World </h3> <p class="mh-card-description"> Explora mundos nuevos y descubre sus secretos. </p> <div class="mh-card-meta"> <span>Aventura</span> <strong>★ 4.8</strong> </div> <a href="/search/label/Juegos" class="mh-card-btn"> VER JUEGO </a> </div> </article> <article class="mh-card"> <div class="mh-card-image"> <div class="mh-card-game-icon">🧙</div> </div> <div class="mh-card-body"> <h3 class="mh-card-title"> RPG Universe </h3> <p class="mh-card-description"> Una aventura RPG llena de posibilidades. </p> <div class="mh-card-meta"> <span>RPG</span> <strong>★ 4.8</strong> </div> <a href="/search/label/Juegos" class="mh-card-btn"> VER JUEGO </a> </div> </article> </div> </section> <!-- =================================================== TENDENCIAS ==================================================== --> <section class="mh-section" id="destacados"> <div class="mh-section-head"> <h2 class="mh-section-title"> 🔥 En <span>tendencia</span> </h2> </div> <div class="mh-featured"> <div class="mh-feature-card"> <div class="mh-feature-content"> <small>MOD HUB</small> <h3> Contenido que está llamando la atención </h3> <p> Descubre las publicaciones y juegos que están destacando dentro de MOD HUB. </p> <a href="/search/" class="mh-btn mh-btn-primary"> Explorar </a> </div> <div class="mh-feature-art"> 🎮 </div> </div> <div class="mh-feature-card"> <div class="mh-feature-content"> <small>NUEVO</small> <h3> Descubre algo diferente </h3> <p> Explora nuevas categorías, juegos y mods publicados en MOD HUB. </p> <a href="/search/" class="mh-btn mh-btn-secondary"> Ver contenido </a> </div> <div class="mh-feature-art"> ⚡ </div> </div> </div> </section> <!-- =================================================== ÚLTIMAS PUBLICACIONES ==================================================== --> <section class="mh-section"> <div class="mh-section-head"> <h2 class="mh-section-title"> 🆕 Últimas <span>publicaciones</span> </h2> <a href="/search/" class="mh-section-link"> Ver más → </a> </div> <div class="mh-posts"> <article class="mh-post"> <div class="mh-post-date"> MOD HUB </div> <h3> Nuevos contenidos próximamente </h3> <p> Mantente atento a las nuevas publicaciones que llegarán a MOD HUB. </p> <a href="/search/"> Ver publicación → </a> </article> <article class="mh-post"> <div class="mh-post-date"> GAMING </div> <h3> Descubre nuevos juegos </h3> <p> Encuentra nuevos títulos y experiencias para agregar a tu colección. </p> <a href="/search/label/Juegos"> Explorar juegos → </a> </article> <article class="mh-post"> <div class="mh-post-date"> MODS </div> <h3> Explora los nuevos mods </h3> <p> Descubre modificaciones y contenido creado para diferentes juegos. </p> <a href="/search/label/Mods"> Explorar mods → </a> </article> </div> </section> </main> <!-- ===================================================== FOOTER ====================================================== --> <footer class="mh-footer"> <div class="mh-footer-inner"> <div> <div class="mh-footer-logo"> MOD <span>HUB</span> </div> <p> Tu espacio gaming. </p> </div> <div class="mh-footer-links"> <a href="/"> Inicio </a> <a href="/search/label/Mods"> Mods </a> <a href="/search/label/Juegos"> Juegos </a> <a href="/p/acerca-de-mi.html"> Acerca de mí </a> <a href="/p/terminos-y-condiciones.html"> Términos </a> <a href="/p/privacidad.html"> Privacidad </a> </div> </div> </footer> </div> <script> (function(){ /* ======================================================= MENÚ MÓVIL ======================================================= */ const menuButton = document.getElementById("mhMenuButton"); const navigation = document.getElementById("mhNavigation"); if(menuButton && navigation){ menuButton.addEventListener("click",function(){ navigation.classList.toggle("show"); }); } /* ======================================================= PERFIL ======================================================= */ const userButton = document.getElementById("mhUserButton"); const profilePanel = document.getElementById("mhProfilePanel"); if(userButton && profilePanel){ userButton.addEventListener("click",function(e){ e.stopPropagation(); profilePanel.classList.toggle("show"); }); document.addEventListener("click",function(e){ if( !profilePanel.contains(e.target) && !userButton.contains(e.target) ){ profilePanel.classList.remove("show"); } }); } /* ======================================================= BUSCADOR ======================================================= */ const searchInput = document.getElementById("mhSearchInput"); const searchButton = document.getElementById("mhSearchButton"); function mhSearch(){ if(!searchInput) return; const value = searchInput.value.trim(); if(value){ window.location.href = "/search?q=" + encodeURIComponent(value); } } if(searchButton){ searchButton.addEventListener( "click", mhSearch ); } if(searchInput){ searchInput.addEventListener( "keydown", function(e){ if(e.key === "Enter"){ mhSearch(); } } ); } /* ======================================================= ANIMACIÓN AL HACER SCROLL ======================================================= */ const elements = document.querySelectorAll( "#MODHUB .mh-card, #MODHUB .mh-post, #MODHUB .mh-feature-card" ); if("IntersectionObserver" in window){ const observer = new IntersectionObserver( function(entries){ entries.forEach(function(entry){ if(entry.isIntersecting){ entry.target.style.opacity="1"; entry.target.style.transform="translateY(0)"; observer.unobserve(entry.target); } }); }, { threshold:.08 } ); elements.forEach(function(el){ el.style.opacity="0"; el.style.transform="translateY(18px)"; el.style.transition="opacity .6s ease, transform .6s ease"; observer.observe(el); }); } })(); </script>]]></b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
              ...
              <b:widget id='FeaturedPost1' locked='true' title='Entrada destacada' type='FeaturedPost' visible='true'>
                <b:widget-settings>
  ...
  <!-- LINT.ThenChange(//depot/google3/java/com/google/blogger/b2/layouts/widgets/v2-style.css) -->
        ...
        <b:section class='footer' id='footer' name='Footer' showaddelement='false' tag='footer'>
          <b:widget id='Attribution1' locked='false' title='' type='Attribution' version='2' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    <div class='blogger'>
      <a expr:href='data:bloggerUrl' rel='nofollow'>
        <span style='color:#ffffff;font-weight:bold;text-shadow:0 0 5px #ff0000,0 0 10px #ff0000,0 0 20px #ff0000;'>
        &#169; 2026 MOD HUB | Todos los derechos reservados
      </span>
       </a>
    </div>
     MOD HUB
    ...
    <aside class='sidebar-container container sidebar-invisible' role='complementary'>
      ...
      <b:section id='sidebar' name='Sidebar' preferred='yes'>
        <b:widget id='PageList2' locked='false' title='Páginas' type='PageList' visible='true'>
          <b:widget-settings>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='Profile1' locked='false' title='Acerca de mí' type='Profile' visible='true'>
          <b:widget-settings>
  ...
  <dd class='profile-textblock'>
    <data:aboutme/>
        ...
        <b:widget id='BlogArchive1' locked='false' title='HORARIOS' type='BlogArchive' visible='false'>
          <b:widget-settings>
