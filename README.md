            ...
            <b:include name='super.searchSubmit'/>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='web (Encabezado)' type='Header' visible='true'>
                    <b:widget-settings>
    ...
    <aside class='sidebar-container container sidebar-invisible' role='complementary'>
      ...
      <b:section id='sidebar' name='Sidebar' preferred='yes'>
        <b:widget id='PageList2' locked='false' title='Páginas' type='PageList' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"6976590038081276461":{"href":"https://web20261.blogspot.com/p/acerca-de-mi.html","position":0,"title":"acerca de mi"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Página Principal</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
